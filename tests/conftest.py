...
def current() -> ProductSales:
    ...
    yield ProductSales(delta=11, total=21, date=today, product_id=9)
...
def prev_two_days() -> ProductSales:
    ...
    yield ProductSales(delta=5, total=10, date=two_days_back, product_id=9)
...
def interpolated_result_two_days(prev_two_days) -> ProductSales:
    ...
    yield [product_sale_1, product_sale_2, prev_two_days]
...
def prev() -> ProductSales:
    ...
    yield ProductSales(delta=5, total=10, date=prev_date, product_id=9)
